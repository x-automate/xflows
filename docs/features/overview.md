...
| **Node catalog** | 39 components across 14 categories, driven by `node-registry.json` (params, defaults, config slots, project configs) | `packages/xflows-catalog/node-registry.json` | [Node catalog](node-catalog.md) |
