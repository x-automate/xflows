...
class LiteLLMRouter:
    ...
    async def chat(self, prompt: str, system_prompt: str | None = None, model_hint: str | None = None, temperature: float = 0.2) -> dict[str, Any]:
        ...
        for model in candidate_models:
            ...
            try:
                ...
                return {
                    "model": model,
                    "provider": CAPABILITY_REGISTRY.get(model, ProviderRoute(model=model, provider="unknown", supports_tools=False, max_context_tokens=0)).provider,
